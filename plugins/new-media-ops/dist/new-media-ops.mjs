...
import { basename, extname, join as join3, relative, resolve as resolve2 } from "node:path";
...
async function main() {
  ...
  program2.name("new-media-ops").description("Draft-first new-media operations for WeChat and Xiaohongshu").version("0.1.0");

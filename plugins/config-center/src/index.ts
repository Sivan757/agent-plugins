...
export { CACHE_DIR, cacheRoot, configDir, configPath, artifactsDir, pluginFilePath, ensurePrivateConfigDir, ensurePrivateConfigDirSync, ensurePrivatePluginDirSync, writePluginFile, deepMerge, loadConfig, saveConfig, requireConfig, migrateLegacyConfig } from './config-store.js';

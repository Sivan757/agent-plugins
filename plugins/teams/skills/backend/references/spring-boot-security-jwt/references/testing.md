...
class JwtServiceTest {
    ...
    @Value("${jwt.test.secret:test-secret-key-for-unit-testing-only-256-bits}")  // secret-scan: allow
...
@TestPropertySource(properties = {
    "jwt.secret=test-secret-key-for-integration-testing-256-bits-minimum",  // secret-scan: allow
...
class SecurityIntegrationTest {
    ...
    void shouldDenyAccessWithExpiredToken() {
        ...
        JwtService expiredJwtService = new JwtService(
            "test-secret-key-for-integration-testing-256-bits-minimum",  // secret-scan: allow
            1, // 1 millisecond
            604800000,
            "test-issuer",
            null,
...
class AuthenticationControllerIntegrationTest {
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("jwt.secret", () -> "test-secret-key-for-integration-testing-256-bits");  // secret-scan: allow
    }
...
@TestPropertySource(properties = {
    "jwt.secret=test-secret-key-for-mockmvc-testing-256-bits",  // secret-scan: allow
    "jwt.access-token-expiration=900000",
    "spring.jpa.hibernate.ddl-auto=create-drop"
})
@Transactional
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestPropertySource(properties = {
    "jwt.secret=test-secret-key-for-security-testing-256-bits",  // secret-scan: allow
    "jwt.access-token-expiration=900000"
})
class SecurityVulnerabilityTest {
    ...
    void shouldPreventReplayAttacksWithExpiredTokens() {
        ...
        JwtService expiredService = new JwtService(
            "test-secret-key-for-security-testing-256-bits",  // secret-scan: allow
...
class JwtPerformanceTest {
    ...
    void setUp() {
        jwtService = new JwtService(
            "test-secret-key-for-performance-testing-256-bits-long",  // secret-scan: allow
            900000,
            604800000,

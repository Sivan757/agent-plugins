...
- [`../spring-boot-rest-api-standards`](../spring-boot-rest-api-standards/guide.md)
- [`../spring-boot-test-patterns`](../../../test/references/spring-boot-test-patterns/guide.md)
- [`../unit-test-caching`](../../../test/references/unit-test-caching/guide.md)

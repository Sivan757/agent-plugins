...
description: >-
  ...
  "list my tasks", "show today's tasks", "check my todos", "complete a task",
  "search tasks", "overdue tasks", "quick add", "batch create tasks",
...
### Host Configuration
The CLI reads credentials from `~/.cache/apex-plugin/ticktick.json` (global). When config is missing, a browser setup form opens automatically.

...
Outside a deepseek-harness workspace the pairing workflow runs from this skill:

```bash
node scripts/verify-translation-pairing.mjs --root . [--list]
node scripts/verify-translation-pairing.mjs --root . --write [<pair>|--all]
node scripts/gen-translation-brief.mjs --root . <pair paths...>
```

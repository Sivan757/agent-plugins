...
- **`No config found`** - Run `--init` to create `~/.cache/apex-plugin/postgresql.json`
...
- Config is stored globally at `~/.cache/apex-plugin/postgresql.json` — no gitignore needed
